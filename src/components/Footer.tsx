...
export default function Footer() {
    return (
        <footer className="bg-[#0a0a0a] border-t border-white/10 text-gray-400 py-10 mt-auto w-full">
            <div className="max-w-6xl mx-auto px-6">
                ...
                <div className="flex flex-col md:flex-row justify-between items-center gap-6">
                    ...
                    <div className="text-center md:text-left">
                        ...
                        <p className="text-sm mt-2 text-gray-500">
                            Watch movies online for free in high quality.
                        </p>
                    </div>
                ...
                <div className="border-t border-gray-800 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center text-xs text-gray-600">
                    <p>This site does not store any files on our server, we only link the media which is hosted on 3rd party services.</p>
